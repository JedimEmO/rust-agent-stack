...
fn main() {
    use google_oauth_example::service;
    ...
    let openrpc_doc = service::generate_googleoauth2service_openrpc();
    ...
    // Also write to file
    match service::generate_googleoauth2service_openrpc_to_file() {
        Ok(()) => {
